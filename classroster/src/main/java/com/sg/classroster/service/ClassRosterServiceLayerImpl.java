...
public class ClassRosterServiceLayerImpl implements ClassRosterServiceLayer {
  ...
  public Student removeStudent(String studentId) throws ClassRosterPersistenceException {
    ...
    /*checking each field in the given object to see, first, that it is not null and, second, 
    that it is not either empty or just whitespace. 
    If any of the fields is either null or empty/whitespace only, 
    this method throws a ClassRosterDataValidationException.*/
